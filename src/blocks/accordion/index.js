...
registerBlockType( 'sgb/accordion', {
	...
	category: 'common',
	description: __(
		'Display a togglable field that can be expanded and collapsed.'
	),
	icon,
	keywords: [ __( 'accordion' ), __( 'list' ), __( 'stag' ) ],
					...
					<Fragment>
						...
						>
							...
							<RichText
								...
								multiline="p"
								className={ classnames(
									'wp-block-sgb-accordion__content'
								) }
				...
				return (
					...
					>
						...
						<RichText.Content
							tagName="div"
							value={ attributes.content }
							className="wp-block-sgb-accordion__content"
						/>
					</details>
				);
			},
